...
tar_option_set(
    ...
    packages <- c(
        ...
        "tarchetypes", "tidybulk", "genekitr", "ggVennDiagram", "IsoformSwitchAnalyzeR", "jsonlite"
    ),
...
group_comparison <- tibble(
    group1 = c("KO10", "KO12", "KO12"),
    group2 = c("WT6", "WT6", "KO10")
)
mapped <- tar_map(
...
list(
    ...
    tar_target(updated_hash, update_hash()),
